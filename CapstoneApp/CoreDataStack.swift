...
class CoreDataStack: NSObject {
    ...
    static let moduleName = "Capstone-App"
    
    // MARK: - Core Data stack
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Dimitrios-Gravvanis.Bitcoin" in the application's documents Application Support directory.
